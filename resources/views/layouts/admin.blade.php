    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                ...
                <a href="" class="logo">
                    <img src="{{ asset('logo.png') }}" alt="navbar brand" class="navbar-brand mb-2"
                        style="width: 130px">
                </a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">PPPoE User</p>
                            ...
                            <div class="card card-stats card-info card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Router</p>
                                                <h4 class="card-title">0</h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-header">
                                    <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill"
                                                ...
                                                aria-selected="true">Pembayaran Internet</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill"
                                                href="#pills-profile" role="tab" aria-controls="pills-profile"
                                                aria-selected="false">Input Pemasukan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill"
                                                href="#pills-contact" role="tab" aria-controls="pills-contact"
                                                aria-selected="false">Input Pengeluaran</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                <table
                                                    class="table table-bordered table-head-bg-secondary table-bordered-bd-info">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">No</th>
                                        ...
                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                <div class="form-group form-show-validation row">
                                                    <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Tanggal</label>
                                                    <div class="col-lg-8 col-md-9 col-sm-8">
                                                        <input type="date" class="form-control" id="tanggal" name="tanggal">
                                                    </div>
                                                </div>
                                                <div class="form-group form-show-validation row">
                                                    <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Item</label>
                                                    <div class="col-lg-8 col-md-9 col-sm-8">
                                                        <input type="text" class="form-control" id="item" name="item">
                                                    </div>
                                                </div>
                                                <div class="form-group form-show-validation row">
                                                    <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Keterangan</label>
                                                    <div class="col-lg-8 col-md-9 col-sm-8">
                                                        <input type="text" class="form-control" id="description" description="item">
                                                    </div>
                                                </div>
                                                <div class="form-group form-show-validation row">
                                                    <label for="username" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Total</label>
                                                    <div class="col-lg-8 col-md-9 col-sm-8">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" id="username-addon">Rp</span>
                                                            </div>
                                                            <input type="text" class="form-control" aria-label="username" aria-describedby="username-addon" id="total" name="total">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-show-validation row">
                                                    <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Metode Bayar</label>
                                                    <div class="col-lg-8 col-md-9 col-sm-8">
